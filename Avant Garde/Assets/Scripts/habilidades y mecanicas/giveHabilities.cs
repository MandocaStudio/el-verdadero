...
public class giveHabilities : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            if (dialogo != null)
            {
                dialogo.managerObject = GameObject.Find("Dialogos");

                Transform childTransform = dialogo.managerObject.transform.Find("Manager Secuencia");

                dialogo.managerSecuencia = childTransform.GetComponent<DialogueSequenceManager>();

                StartCoroutine(dialogo.empezar());
            }
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            StartCoroutine(dialogo.finalizar());
        }
    }
